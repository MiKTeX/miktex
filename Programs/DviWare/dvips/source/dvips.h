...
#if defined(MIKTEX)
#include "miktex-dvips-version.h"
#define BANNER \
"This is dvips(k) " MIKTEX_COMP_ORIG_VERSION_STR " (" MIKTEX_PRODUCTNAME_STR MIKTEX_VERSION_STR ")  Copyright 2023 Radical Eye Software"
#else
#define BANNER \
