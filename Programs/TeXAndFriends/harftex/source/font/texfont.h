...
typedef struct texfont {
    ...
    int _font_index;            /* font index in font collection formats */
} texfont;
...
#  define font_index(a)                  font_tables[a]->_font_index
#  define set_font_index(a,b)            font_index(a) = b
...
extern int char_supported(halfword p);
