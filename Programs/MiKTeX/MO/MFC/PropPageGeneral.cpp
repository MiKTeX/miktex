...
bool PropPageGeneral::ReadDirectory(const PathName & path, vector<string> & subDirNames, vector<string> & fileNames, vector<string> & fileNameInfos)
{
  UNUSED_ALWAYS(path);
...
bool PropPageGeneral::OnProgress(unsigned level, const PathName & directory)
{
  UNUSED_ALWAYS(level);
