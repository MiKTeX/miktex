...
vector<FileLink> LinksManager::CollectLinks(LinkCategoryOptions linkCategories)
{
  ...
  if (linkCategories[LinkCategory::MiKTeX])
  {
    ...
    PathName console(ctx->session->GetSpecialPath(SpecialPath::MacOsDirectory) / MIKTEX_MACOS_BUNDLE_NAME);
...
const vector<FileLink> LinksManager::miktexFileLinks =
{
  ...
  { MIKTEX_PREFIX "ctwill" MIKTEX_EXE_FILE_SUFFIX, { "ctwill"} },
  { MIKTEX_PREFIX "ctwill-refsort" MIKTEX_EXE_FILE_SUFFIX, { "ctwill-refsort"} },
  { MIKTEX_PREFIX "ctwill-twinx" MIKTEX_EXE_FILE_SUFFIX, { "ctwill-twinx"} },
  ...
  { MIKTEX_PREFIX "hitex" MIKTEX_EXE_FILE_SUFFIX, { "hitex"} },
  { MIKTEX_PREFIX "histretch" MIKTEX_EXE_FILE_SUFFIX, { "histretch"} },
  { MIKTEX_PREFIX "hishrink" MIKTEX_EXE_FILE_SUFFIX, { "hishrink"} },
