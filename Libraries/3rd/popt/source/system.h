...
#    define MIKTEXPOPTAPI(type) MIKTEXDLLEXPORT type MIKTEXCEECALL
#    define MIKTEXPOPTCALLBACK MIKTEXCEECALL
#    if defined(__cplusplus)
#      define MIKTEXPOPTDATA(type) extern "C" MIKTEXDLLEXPORT type
#    else
#      define MIKTEXPOPTDATA(type) MIKTEXDLLEXPORT type
#    endif
#  else
